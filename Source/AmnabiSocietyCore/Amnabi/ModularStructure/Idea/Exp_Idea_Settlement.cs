...
namespace Amnabi {
    ...
    public class Exp_UpgradeBuilding : Exp_Idea {
        ...
        public override string texturePath()
        {
            return "UI/IdeaIcons/Settlement";
        }
        public Exp_UpgradeBuilding() { }
				    ...
				    foreach(Pawn pawn in noconcurrency)
				    {
					    ...
					    if(pawn.BusyLevel() < Busy.High)
                        {
                            if(cpi.personalIdentity.draftCompliance(pawn, facData.authority, true) == Compliance.Compliant)
							{
								...
								if(!JobList.JG_FightAll.DoJob(pawn, default(JobIssueParams)))
								{
									if(!JobList.JG_ApproachHostile.DoJob(pawn, default(JobIssueParams)))
									{
									}
								}
							}
    ...
    public class Exp_GatherResource : Exp_Idea {
        ...
        public override string texturePath()
        {
            return "UI/IdeaIcons/Resource";
        }
        public Exp_GatherResource() { }
