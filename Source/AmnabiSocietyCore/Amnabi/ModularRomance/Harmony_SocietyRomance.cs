...
namespace Amnabi {
    public class Harmony_SocietyRomance {
        public static void Patch(HarmonyLib.Harmony harmony)
        {
			harmony.Patch(AccessTools.Method(typeof(PawnRelationWorker_Fiance), "OnRelationCreated"), null, new HarmonyMethod(typeof(Harmony_SocietyRomance), nameof(FianceOnRelationCreatedPost), null), null);
            harmony.Patch(AccessTools.Method(typeof(InteractionWorker_RomanceAttempt), "RandomSelectionWeight", null, null), new HarmonyMethod(typeof(Harmony_SocietyRomance), nameof(InteractionWorker_RomanceAttempt_RandomSelectionWeight), null), null, null);
            harmony.Patch(AccessTools.Method(typeof(InteractionWorker_MarriageProposal), "RandomSelectionWeight", null, null), new HarmonyMethod(typeof(Harmony_SocietyRomance), nameof(InteractionWorker_MarriageProposal_RandomSelectionWeight), null), null, null);
            harmony.Patch(AccessTools.Method(typeof(InteractionWorker_RomanceAttempt), "Interacted", null, null), new HarmonyMethod(typeof(Harmony_SocietyRomance), nameof(InteractionWorker_RomanceAttemptInteracted), null), null, null);
            harmony.Patch(AccessTools.Method(typeof(Pawn_RelationsTracker), "SecondaryLovinChanceFactor", null, null), new HarmonyMethod(typeof(Harmony_SocietyRomance), nameof(Pawn_RelationsTracker_SecondaryLovinChanceFactor), null), null, null);
