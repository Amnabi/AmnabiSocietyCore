...
namespace Amnabi {
    ...
    public class Exp_MarriagableAge : Exp_Idea {
        ...
        public override string texturePath()
        {
            if(sex == Sex.Female)
            {
                return "UI/IdeaIcons/RelationshipInitiative_Female";
            }
            else if(sex == Sex.Male)
            {
                return "UI/IdeaIcons/RelationshipInitiative_Male";
            }
            else
            {
                return "UI/IdeaIcons/RelationshipInitiative_Both";
            }
        }
    ...
    public class Exp_Polygamy : Exp_Idea {
        ...
        public override string texturePath()
        {
            switch(sex)
            {
                case Sex.None:
                {
                    return "UI/IdeaIcons/Monogamy";
                }
                case Sex.Male:
                {
                    return "UI/IdeaIcons/Polygyny";
                }
                case Sex.Female:
                {
                    return "UI/IdeaIcons/Polyandry";
                }
                case Sex.Both:
                {
                    return "UI/IdeaIcons/Polygamy";
    ...
    public class Exp_MarriageLastName : Exp_Idea {
        ...
        public override string texturePath()
        {
            switch(varMarriageDynasty)
            {
                case MarriageDynasty.NoChange:
                {
                    return "UI/IdeaIcons/NoneMarriage";
                }
                case MarriageDynasty.Paterlineal:
                {
                    return "UI/IdeaIcons/PaterlinealMarriage";
                }
                case MarriageDynasty.Materlineal:
                {
                    return "UI/IdeaIcons/MaterlinealMarriage";
                }
            }
            return null;
        }
